...
from bridge import BonsaiBridge
...
assert d["dry_run"] is True and d["chunks"] == 1
...
print("BRIDGE OK - save-first, chunk to cap (3 chunks), dry-run default, confirm gate blocks arbitrary code")
