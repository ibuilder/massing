...
function pickFolder(nodes: DocFolderNode[], name: string): Promise<string | null> {
  return new Promise((res) => {
    ...
    box.innerHTML = `<div style="font-weight:600;margin-bottom:4px">Save to Documents</div><div class="meta" style="margin-bottom:10px">${escapeHtml(name)} → choose a standard folder</div>`;
