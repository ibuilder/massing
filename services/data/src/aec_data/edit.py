...
def _recipe_add_family(model, p):
    ...
    catalog key. Optional `dims` ([w, d, h] m) places a parametrically-sized type variant; optional
    ...
    return families.add_family(model, p["family"], p.get("storey"), p.get("position"), dims)
