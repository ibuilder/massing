...
TESTS = ["test_proforma", "test_cost", "test_modules", "test_dashboard",
         ...
         "test_grid", "test_propmap", "test_layers", "test_graph", "test_fitout", "test_logistics", "test_types", "test_groups", "test_phasing", "test_lod500", "test_selector", "test_representations", "test_openings", "test_detailing", "test_rules", "test_drawing", "test_sections", "test_view_range", "test_dxf", "test_specmanual", "test_steel_connections", "test_rebar", "test_mep_systems", "test_wave11_edges", "test_unit_scale", "test_curtainwall", "test_nlauthor", "test_nl_ai", "test_guards", "test_edit_undo", "test_sandbox", "test_wall_slope", "test_mesh", "test_annotation", "test_content", "test_content_import", "test_structural", "test_analytical", "test_struct_solve", "test_docgraph", "test_rfi_qa", "test_nodegraph", "test_drawing_set", "test_project_package", "test_mep_families", "test_architectural", "test_preview", "test_ifc_cache",
