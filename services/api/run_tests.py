...
TESTS = ["test_proforma", "test_cost", "test_modules", "test_dashboard",
         ...
         "test_prequal", "test_payapp", "test_accounting", "test_carbon", "test_codecheck", "test_code_analysis", "test_pricing",
