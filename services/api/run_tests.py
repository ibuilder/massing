...
TESTS = ["test_proforma", "test_cost", "test_modules", "test_dashboard",
         ...
         "test_markup", "test_route_authz", "test_global_authz", "test_ref_counter", "test_audit_coverage", "test_bsdd",
