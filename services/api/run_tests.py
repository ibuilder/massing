...
TESTS = ["test_provenance_report", "test_provenance_estimate_leg", "test_answers_leg_roundtrip", "test_proforma", "test_renovation", "test_rollover", "test_income_basis", "test_cost", "test_g702_lines", "test_modules", "test_dashboard",
         ...
         "test_bundle", "test_bundle_preview", "test_asset_rights", "test_desktop", "test_localmode", "test_project_budget", "test_rvt_bridge",
         ...
         "test_module_config", "test_module_aggregate", "test_view_config", "test_view_sharing", "test_view_alerts_per_viewer", "test_markup_rekey", "test_view_crossmodule", "test_report_catalog", "test_env_documented", "test_module_schema", "test_field_attrs", "test_eticket_tm", "test_tm_rates", "test_ref_backfill", "test_module_tables", "test_revision_comments", "test_module_filters", "test_system_columns", "test_court_primary", "test_guid_integrity", "test_pay_application", "test_cost_calibration", "test_scenario_provenance", "test_scratch_ignored", "test_module_fields", "test_pair_filter", "test_ref_sort", "test_ref_label", "test_csv_sweep", "test_limit_filter", "test_truncation_disclosed", "test_pin_cap", "test_pin_empty", "test_pin_pgnull", "test_json_null_filter", "test_pin_population", "test_pin_anchor", "test_fragments_python", "test_fragments_schema", "test_fragconvert_timeout", "test_fragconvert_kill", "test_count_over", "test_penny_split", "test_throttle", "test_route_order", "test_mutating_get", "test_bootstrap_admin", "test_licence_allowlist", "test_money_parity", "test_money_spine", "test_plan_transform", "test_massingcapture_vendor", "test_xml_parse_hardening", "test_supply_chain_gate", "test_mspdi_xxe", "test_scenario_authz", "test_changelog_current", "test_release_current", "test_tested_but_unwired", "test_actions_pinned", "test_container_pr_gate", "test_spatial_tree", "test_output_encoding", "test_massingplan_vendor", "test_vendor_reachable", "test_schedule_health", "test_schedule_locations", "test_schedule_takt", "test_schedule_levelling", "test_schedule_progress", "test_schedule_risk_mc", "test_ppc_divergence", "test_ppc_field_conformance", "test_schedule_compare", "test_schedule_windows", "test_schedule_modelled", "test_schedule_p6xml", "test_schedule_earned", "test_schedule_compression", "test_schedule_portfolio", "test_portfolio_authz", "test_programme_gantt", "test_no_exception_relay", "test_vendor_drift",
         ...
         "test_markup", "test_route_authz", "test_resource_id_authz", "test_route_reachability", "test_route_shadow", "test_body_param_reach", "test_resumable_upload", "test_model_align", "test_ifc_parse_gate", "test_plugin_isolation", "test_body_pid_authz", "test_global_authz", "test_protected_prefix_coverage", "test_baseline", "test_global_mutating_authz", "test_ref_counter", "test_audit_coverage", "test_bsdd",
         "test_openbim_registry", "test_waterfall", "test_waterfall_cents", "test_sessions", "test_mfa", "test_stored_ids", "test_cobie", "test_fts_index", "test_scim", "test_scim_provision_race", "test_natural_key_race", "test_seeding_sweep", "test_unique_read_guard", "test_member_role_race", "test_bcf_reimport_dedupe", "test_model_version_collision", "test_saml", "test_responsibility", "test_audit_commit", "test_array_live", "test_assemblies",
         ...
         "test_sentry", "test_otel", "test_doctext_source", "test_docs_module_schema", "test_schema_stale", "test_schema_strictness", "test_schema_types_agree", "test_verdict_coverage",
         ...
         "test_no_secrets", "test_rate_shared", "test_race_conditions", "test_transition_cas", "test_rmw_sweep", "test_gap_records", "test_lock_satisfies_requirements", "test_manifest", "test_alembic_single_head",
...
def _owned_dbs(t: str, cwd: Path) -> set[Path]:
    ...
    **That sentence was aspirational until 2026-09-06 and is now enforced.** 44 tests declared theirs
    with `os.environ.setdefault`, which this regex cannot match and which does not declare anything
    anyway — it yields to whatever the shell carries. Under this runner that was invisible, because
    the runner injects `DATABASE_URL` per test, so the property held by the INJECTION rather than by
    the declaration the docstring credited it to. `test_db_url_isolation.py` now holds it directly.
