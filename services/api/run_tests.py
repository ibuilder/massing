...
TESTS = ["test_proforma", "test_cost", "test_modules", "test_dashboard",
         ...
         "test_prequal", "test_payapp", "test_accounting", "test_carbon", "test_codecheck", "test_code_analysis", "test_codes", "test_approvability", "test_rfi_readiness", "test_readiness_bcf", "test_productivity", "test_ebc", "test_element_connections", "test_pricing",
         ...
         "test_grid", "test_propmap", "test_layers", "test_graph", "test_fitout", "test_logistics", "test_types", "test_groups", "test_phasing", "test_lod500", "test_selector", "test_representations", "test_openings", "test_detailing", "test_rules", "test_drawing", "test_sections", "test_dxf", "test_specmanual", "test_steel_connections", "test_rebar", "test_mep_systems", "test_wave11_edges", "test_unit_scale", "test_curtainwall", "test_nlauthor", "test_nl_ai", "test_guards", "test_edit_undo", "test_sandbox", "test_wall_slope", "test_mesh", "test_content", "test_content_import", "test_structural", "test_mep_families", "test_architectural", "test_preview",
