...
TESTS = ["test_proforma", "test_cost", "test_modules", "test_dashboard",
         ...
         "test_gltf_export", "test_gltf_compress", "test_ifc5_read", "test_ifcx_write", "test_model_events", "test_docmanager", "test_proforma_provenance", "test_filed_output",
