...
TESTS = ["test_proforma", "test_cost", "test_modules", "test_dashboard",
         ...
         "test_scan_deviation", "test_plan_to_bim", "test_errorlog", "test_import_cycles", "test_tenant_scoping", "test_schedule_risk", "test_carbon_compliance", "test_permit_check", "test_drawing_qa", "test_element_5d", "test_authoring_matrix", "test_option_score", "test_plugin_registry", "test_jobs", "test_sheet_layout"]
