...
TESTS = ["test_provenance_report", "test_provenance_estimate_leg", "test_answers_leg_roundtrip", "test_proforma", "test_renovation", "test_rollover", "test_income_basis", "test_cost", "test_g702_lines", "test_modules", "test_dashboard",
         ...
         "test_openbim_registry", "test_waterfall", "test_waterfall_cents", "test_sessions", "test_mfa", "test_stored_ids", "test_cobie", "test_fts_index", "test_scim", "test_scim_provision_race", "test_natural_key_race", "test_seeding_sweep", "test_unique_read_guard", "test_member_role_race", "test_bcf_reimport_dedupe", "test_saml", "test_responsibility", "test_array_live", "test_assemblies",
