...
REPORTS: dict[str, tuple[str, str]] = {
    ...
    "investor_pack": ("Investor Pack (returns + S&U + scenarios)", "Capital"),
    "ic_memo": ("Investment Committee Memo", "Capital"),
    ...
    "field_log": ("Field-Log Rollup", "Daily Log"),
    ...
    "estimate_continuity": ("Estimate Continuity (Preconstruction)", "Estimating"),
    "decision_log": ("Decision Log", "Project Governance"),
    "assumptions_register": ("Assumptions & Clarifications", "Project Governance"),
    "precon_alignment": ("Preconstruction Alignment", "Project Governance"),
    "stakeholder_analysis": ("Stakeholder Analysis (power/interest)", "Project Controls"),
    "spec_submittal_log": ("Spec-Driven Submittal Log", "Specifications"),
    "site_feasibility": ("Site Feasibility / Zoning Envelope", "Feasibility"),
    ...
    "model_health": ("Model Health Scorecard", "Quality"),
    "bep": ("BIM Execution Plan (BEP, ISO 19650)", "Quality"),
    "cep": ("Construction Execution Plan (CEP)", "Quality"),
    "verified_progress": ("Verified-as-built Progress", "Progress"),
    ...
    "mep": ("MEP Equipment Schedule", "Model"),
    "resource_loading": ("Resource-Loaded Schedule", "Schedule"),
    "envelope": ("Envelope Code Compliance (IECC)", "Model"),
    "productivity": ("Field Labor Productivity", "Daily Log"),
}
...
_BUILDERS: dict[str, Callable[[Session, str, str], Report]] = {
    ...
    "rent_roll": _rent_roll, "lease_management": _lease_management, "cap_table": _cap_table, "investor_pack": _investor_pack, "ic_memo": _ic_memo,
    ...
    "bim_kpi": _bim_kpi, "model_health": _model_health, "listing_factsheet": _listing_factsheet, "marketing_flyer": _marketing_flyer,
