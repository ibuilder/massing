...
from .routers import (accounting, analysis, auth, authoring, benchmarking, bidding, bim, carbon, closeout, codecheck, connections, contracts, convert, cost,
                      dashboard, drafting, drawings, ids, exports, generate, modules, opendata, payapp, prequal, pricing, realestate, reports, research, review, proforma, properties, schedule,
