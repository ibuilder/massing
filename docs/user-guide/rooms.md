...
2. **Nothing is hidden.** All 133 modules stay reachable four ways: from their room, from the element
...
- [modules.md](modules.md) — what the 133 registers are and how records work.
