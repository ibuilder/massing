...
2. **Nothing is hidden.** All 137 modules stay reachable four ways: from their room, from the element
...
- [modules.md](modules.md) — what the 137 registers are and how records work.
