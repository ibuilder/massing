...
| `runway-claude-2026-08-19.md` | **LIVE** — handoff after **v0.3.1001** (PR #297, 988–1001). Land order vs the 987 stack; next is FIELD-MODE remainder or charts colour, not emptyGuide→module.json alone. | not superseded — active |
