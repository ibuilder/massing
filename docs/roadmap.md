...
| **I · API client** | `apps/web/src/api/` | SCALE-SEAM ⑬ · SCALE-SEAM ⑭ · SCALE-SEAM ⑮ · SCALE-SEAM ⑯ |
...
- ◧ ⭐ **SCALE-SEAM ⑯ — `client.ts` is no longer a god-file, but the split is not finished.** *(⑯ `/elements` SHIPPED v0.3.1021; ②–⑮ already shipped)*
  ...
  **`client.ts` went 4,956 → 3,412 lines** (`wc -l`). Next is the next route-group by size; pick it by
